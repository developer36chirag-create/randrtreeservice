...
const NAV = [
...

  {
    ...
    sub: [
      ...
      { label: 'Crane Rental Services', href: '/services' },
      { label: 'Firewood Delivery', href: '/firewood-delivery' },
      { label: 'Mulch Delivery', href: '/services' },
      { label: 'Retention Pond Maintenance', href: '/retention-pond-maintenance' },
    ],
  },

  {
    ...
    sub: [
      ...
      { label: 'Avondale Estates', href: '/avondale-estates' },
      { label: 'Buford', href: '/buford' },
      { label: 'Cumming', href: '/cumming' },
      { label: 'Decatur', href: '/decatur' },
      { label: 'Duluth', href: '/duluth' },
      { label: 'Flowery Branch', href: '/services' },
      { label: 'Gainesville', href: '/services' },
      { label: 'Grayson', href: '/services' },
      { label: 'Lawrenceville', href: '/services' },
      { label: 'Lilburn', href: '/services' },
      { label: 'Norcross', href: '/services' },
      { label: 'Roswell', href: '/services' },
      { label: 'Snellville', href: '/services' },
      { label: 'Stone Mountain', href: '/services' },
      { label: 'Sugar Hill', href: '/services' },
      { label: 'Suwanee', href: '/services' },
    ],
  },
