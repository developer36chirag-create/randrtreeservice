...
const ALPHARETTA_DATA = {
  ...
  heroSubtitle:
    "R & R Tree Service is your trusted partner for professional, affordable tree care in Buford, GA. Our experienced team is dedicated to keeping your property safe, healthy, and looking its best. From removing dangerous trees to enhancing your yard with precise trimming, stump grinding, and storm damage cleanup, we’re here to handle all your tree care needs quickly and efficiently.",

  /* Intro section */
  introText1:
    "We understand the unique tree challenges and landscaping goals of Buford property owners, and we take pride in delivering solutions that protect your investment and enhance curb appeal.",
  introText2:
    'Call us today or contact us online to schedule your free estimate in Buford!',
  ...
  services: [
    ...
    },
    {
      ...
      desc: "Storm damage? Fallen trees? We're available for fast, reliable emergency response to protect your property and restore safety. Our crew responds 24/7 across Buford and surrounding areas.",
  ...
  neighborhoods: [
    {
      name: 'Historic Downtown Buford',
      img: '/Historic-Downtown-Buford.webp',
    },
    {
      name: 'Hamilton Mill area',
      img: '/Hamilton-Mill-area.webp',
    },
    {
      name: 'Buford Dam Road neighborhoods',
      img: '/Buford-Dam-Road-neighborhoods.webp',
    },
    {
      name: 'Near the Mall of Georgia',
      img: '/Near-the-Mall-of-Georgia.webp',
    },
  ],
  ...
  whyPoints: [
    ...
    },
    {
      ...
      desc: "Complete liability coverage on every job in Buford. Your property and our crew are protected — you'll never face unexpected costs.",
    },
    {
    ...
    },
    {
      ...
      desc: "Storm season is unpredictable. We're on call 24/7 to respond fast to fallen trees, storm damage, and urgent hazards across Buford.",
    },
  ],

  /* 4-step process */
  processSteps: [
    { num: '01', icon: '📞', title: 'Free Consultation', desc: 'Call or message us. We visit your Buford property, assess the situation, and answer all your questions — no obligation.' },
    ...
    { num: '04', icon: '✅', title: 'Complete Cleanup', desc: 'We remove all debris, branches, and wood. Your Buford yard is left immaculate. We follow up to confirm your satisfaction.' },
  ],
  ...
  reviews: [
    ...
    {
      text: "We have used R and R Tree Service since we moved to the Buford area over 16 years ago. They are professional, dependable, and do an excellent job. Their crane service is a definite advantage — there is never any damage to surrounding trees.",
      name: 'John & Carol H.',
      loc: 'Buford, GA',
      wide: false,
    },
