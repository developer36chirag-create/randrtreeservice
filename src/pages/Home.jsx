...
const FAQS = [
  ...
  { q:'What safety protocols do you follow?', a:'We develop, implement, and enforce a comprehensive safety program with written procedures, safety training, proper PPE, and daily hazard assessments before each workday.' },
...
const TESTIMONIALS = [
  ...
  { text:"R&R recently removed more than a dozen trees from our heavily wooded lot. The team showed up on time and did an incredibly safe and thorough job. We would not hesitate to call them back or refer their services.", name:'Michael & Jennifer L.', loc:'Lawrenceville, GA', wide:false },
  { text:"Within 24-hours of being contacted, Randy and his team gave me a quote and removed two mature trees uprooted during Hurricane Helene. They arrived at the crack of dawn, addressed this very threatening situation, and finished before lunch. True pros.", name:'Jane B.', loc:'Georgia', wide:true },
];
