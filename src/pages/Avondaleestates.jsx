...
const ALPHARETTA_DATA = {
  ...
  heroSubtitle:
    "At R & R Tree Service, we’re proud to offer top-quality, affordable tree care for homeowners and businesses in Avondale Estates, GA. With years of experience and a strong focus on customer satisfaction, we help keep your property safe, healthy, and beautiful. Whether you need expert tree removal, precise pruning, stump grinding, or fast emergency storm cleanup, our team is ready to serve you.",

  /* Intro section */
  introText1:
    "We understand the unique character and tree care needs of Avondale Estates’ historic neighborhoods and take pride in preserving the beauty and safety of your landscape.",
  introText2:
    'Call us today or contact us online to schedule your free estimate in Avondale Estates!',
  ...
  services: [
    ...
    },
    {
      ...
      desc: "Storm damage? Fallen trees? We're available for fast, reliable emergency response to protect your property and restore safety. Our crew responds 24/7 across Avondale Estates and surrounding areas.",
  ...
  neighborhoods: [
    {
      name: 'Historic Downtown Avondale Estates',
      img: '/Historic-Downtown-Avondale-Estates.webp',
    },
    {
      name: 'Kensington Road area',
      img: '/Kensington-Road-area.webp',
    },
    {
      name: 'Rockbridge Road corridor',
      img: '/Rockbridge-Road-corridor.webp',
    },
  ],
  ...
  whyPoints: [
    ...
    },
    {
      ...
      desc: "Complete liability coverage on every job in Avondale Estates. Your property and our crew are protected — you'll never face unexpected costs.",
    },
    {
    ...
    },
    {
      ...
      desc: "Storm season is unpredictable. We're on call 24/7 to respond fast to fallen trees, storm damage, and urgent hazards across Avondale Estates.",
    },
  ],

  /* 4-step process */
  processSteps: [
    { num: '01', icon: '📞', title: 'Free Consultation', desc: 'Call or message us. We visit your Avondale Estates property, assess the situation, and answer all your questions — no obligation.' },
    ...
    { num: '04', icon: '✅', title: 'Complete Cleanup', desc: 'We remove all debris, branches, and wood. Your Avondale Estates yard is left immaculate. We follow up to confirm your satisfaction.' },
  ],
  ...
  reviews: [
    ...
    {
      text: "We have used R and R Tree Service since we moved to the Avondale Estates area over 16 years ago. They are professional, dependable, and do an excellent job. Their crane service is a definite advantage — there is never any damage to surrounding trees.",
      name: 'John & Carol H.',
      loc: 'Avondale Estates, GA',
      wide: false,
    },
    {
