...
const ALPHARETTA_DATA = {
  ...
  heroSubtitle:
    "At R & R Tree Service, we proudly provide dependable, affordable tree care to homeowners and businesses across Cumming, GA. Whether you need a hazardous tree removed, your trees pruned for health and appearance, a stump eliminated, or help after a storm, our skilled team is ready to help you protect and beautify your property.",

  /* Intro section */
  introText1:
    "We’re familiar with the landscapes and tree care needs unique to Cumming and take pride in keeping your yard safe and stunning year-round.",
  introText2:
    'Call us today or contact us online to schedule your free estimate in Cumming!',

  /* Trusted local expert points */
  localPoints: [
    'Locally owned with years of hands-on experience',
    'Fully insured & licensed for your security',
    'Honest, upfront pricing — no hidden fees',
    'Courteous, knowledgeable crew',
    'Available for emergency calls when you need us most',
  ],
  ...
  services: [
    ...
    },
    {
      ...
      desc: "Storm damage? Fallen trees? We're available for fast, reliable emergency response to protect your property and restore safety. Our crew responds 24/7 across Cumming and surrounding areas.",
  ...
  neighborhoods: [
    {
      name: 'Downtown Cumming',
      img: '/Downtown-Cumming.webp',
    },
    {
      name: 'Bald Ridge Marina area',
      img: '/Bald-Ridge-Marina-area.webp',
    },
    {
      name: 'Castleberry Road neighborhoods',
      img: '/Castleberry-Road-neighborhoods.webp',
    },
    {
      name: 'Around Lake Lanier',
      img: '/Around-Lake-Lanier.webp',
    },
  ],
  ...
  whyPoints: [
    ...
    },
    {
      ...
      desc: "Complete liability coverage on every job in Cumming. Your property and our crew are protected — you'll never face unexpected costs.",
    },
    {
    ...
    },
    {
      ...
      desc: "Storm season is unpredictable. We're on call 24/7 to respond fast to fallen trees, storm damage, and urgent hazards across Cumming.",
    },
  ],

  /* 4-step process */
  processSteps: [
    { num: '01', icon: '📞', title: 'Free Consultation', desc: 'Call or message us. We visit your Cumming property, assess the situation, and answer all your questions — no obligation.' },
    ...
    { num: '04', icon: '✅', title: 'Complete Cleanup', desc: 'We remove all debris, branches, and wood. Your Cumming yard is left immaculate. We follow up to confirm your satisfaction.' },
  ],
  ...
  reviews: [
    ...
    {
      text: "We have used R and R Tree Service since we moved to the Cumming area over 16 years ago. They are professional, dependable, and do an excellent job. Their crane service is a definite advantage — there is never any damage to surrounding trees.",
      name: 'John & Carol H.',
      loc: 'Cumming, GA',
      wide: false,
    },
