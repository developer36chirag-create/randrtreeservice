...
const ALPHARETTA_DATA = {
  ...
  heroSubtitle:
    "At R & R Tree Service, we’re proud to be the go-to tree care experts for homeowners and businesses throughout Decatur, GA. Our experienced team is here to help you maintain a safe, beautiful property with services that include tree removal, trimming, stump grinding, and emergency storm response — all at a fair price.",

  /* Intro section */
  introText1:
    "From the charming historic homes to newer developments, we understand how to care for the unique trees and landscapes that make Decatur special",
  introText2:
    'Call us today or contact us online to schedule your free estimate in Decatur!',

  /* Trusted local expert points */
  localPoints: [
    'Locally owned & deeply familiar with Decatur’s neighborhoods',
    'Fully licensed and insured for your protection',
    'Competitive rates with no surprises',
    'Friendly, reliable professionals who respect your property',
    'Emergency services available when you need them most',
  ],
  ...
  services: [
    ...
    },
    {
      ...
      desc: "Storm damage? Fallen trees? We're available for fast, reliable emergency response to protect your property and restore safety. Our crew responds 24/7 across Decatur and surrounding areas.",
  ...
  whyPoints: [
    ...
    },
    {
      ...
      desc: "Complete liability coverage on every job in Decatur. Your property and our crew are protected — you'll never face unexpected costs.",
    },
    {
    ...
    },
    {
      ...
      desc: "Storm season is unpredictable. We're on call 24/7 to respond fast to fallen trees, storm damage, and urgent hazards across Decatur.",
    },
  ],

  /* 4-step process */
  processSteps: [
    { num: '01', icon: '📞', title: 'Free Consultation', desc: 'Call or message us. We visit your Decatur property, assess the situation, and answer all your questions — no obligation.' },
    ...
    { num: '04', icon: '✅', title: 'Complete Cleanup', desc: 'We remove all debris, branches, and wood. Your Decatur yard is left immaculate. We follow up to confirm your satisfaction.' },
  ],
  ...
  reviews: [
    ...
    {
      text: "We have used R and R Tree Service since we moved to the Decatur area over 16 years ago. They are professional, dependable, and do an excellent job. Their crane service is a definite advantage — there is never any damage to surrounding trees.",
      name: 'John & Carol H.',
      loc: 'Decatur, GA',
      wide: false,
    },
