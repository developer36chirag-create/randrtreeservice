...
const ALPHARETTA_DATA = {
  ...
  heroSubtitle:
    "At R&R Tree Service, we're proud to provide high-quality, affordable tree care for homeowners and businesses throughout Alpharetta, GA. With years of experience and a commitment to customer satisfaction, we help keep your property safe, beautiful, and well-maintained. Whether you need tree removal, pruning, stump grinding, or emergency storm cleanup, our team is here for you.",

  /* Intro section */
  introText1:
    "We understand the unique tree care needs in Alpharetta's neighborhoods and take pride in protecting your home or business while enhancing the natural beauty of your landscape.",
  introText2:
    'Call us today or contact us online to schedule your free estimate in Alpharetta!',
  ...
  services: [
    ...
    },
    {
      ...
      desc: "Storm damage? Fallen trees? We're available for fast, reliable emergency response to protect your property and restore safety. Our crew responds 24/7 across Alpharetta and surrounding areas.",
  ...
  neighborhoods: [
    ...
    {
      name: 'Milton / Crabapple',
      img: '/Milton-Crabapple-area.webp',
    },
  ],
  ...
  whyPoints: [
    ...
    },
    {
      ...
      desc: "Complete liability coverage on every job in Alpharetta. Your property and our crew are protected — you'll never face unexpected costs.",
    },
    {
    ...
    },
    {
      ...
      desc: "Storm season is unpredictable. We're on call 24/7 to respond fast to fallen trees, storm damage, and urgent hazards across Alpharetta.",
    },
  ],

  /* 4-step process */
  processSteps: [
    { num: '01', icon: '📞', title: 'Free Consultation', desc: 'Call or message us. We visit your Alpharetta property, assess the situation, and answer all your questions — no obligation.' },
    ...
    { num: '04', icon: '✅', title: 'Complete Cleanup', desc: 'We remove all debris, branches, and wood. Your Alpharetta yard is left immaculate. We follow up to confirm your satisfaction.' },
  ],
